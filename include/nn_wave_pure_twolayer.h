...
#include "particle.h"
#include "random.h"
#include "neural_twolayer.h"

using namespace arma;

/// @brief The TwoLayerNetworkWavefunction class is a Restricted Boltzmann machine.
/// @details Gaussian-Binary without intercations.
class TwoLayerNetworkWavefunction : public WaveFunction
{
public:
    /// @brief Constructor for the TwoLayerNetworkWavefunction class.
    /// @param TODO: document
    //TwoLayerNetworkWavefunction(size_t rbs_M, size_t rbs_N, std::vector<double> parameters, double omega);
    TwoLayerNetworkWavefunction(size_t rbs_M, size_t rbs_N, std::vector<double> parameters, double omega, double alpha, double beta, double adiabaticFactor);
...
protected:
    ...
    NeuralNetworkTwoLayers m_neuralNetwork;
