...
if(thread_id==0){
cout << "Parameters: " ;
//All parameters in param are. Loop and print them:
for (size_t i = 0; i < params.size(); ++i) {
    cout << " " << params[i];
}
cout << " Lenth: " << params.size() ;
cout << endl;
}
...
//cout << "Equilibrium steps: " << numberOfEquilibrationStepsPerEpoch << " Steady state steps: " << numberOfSteadyStateStepsPerEpoch << endl;
        ...
        auto acceptedEquilibrationSteps = system->runEquilibrationSteps(
            stepLength,
            numberOfEquilibrationStepsPerEpoch*10);
...
double beta = 2.82843; // beta is the second parameter for now.
    ...
    string energies_plot_filename = "energies_plot_twolayer_" + fileSuffix  + ".csv";
