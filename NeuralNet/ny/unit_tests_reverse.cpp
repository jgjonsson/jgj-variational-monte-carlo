...
std::vector<double> calculateNumericalGradientParameters(std::unique_ptr<NeuralNetworkReverse>& looseNeuralNetwork, std::vector<double>& inputs) {
...
std::vector<double> calculateNumericalGradientInputs(std::unique_ptr<NeuralNetworkReverse>& looseNeuralNetwork, std::vector<double>& inputs) {
    double epsilon = 1e-6; // small number for finite difference
...
/*
std::vector<double> calculateNumericalGradient(std::unique_ptr<NeuralNetworkReverse>& looseNeuralNetwork, std::vector<double>& inputs) {
    double epsilon = 1e-6; // small number for finite difference
    std::vector<double> gradient(inputs.size());
...
int main(int argc, char **argv)
{
	...
	auto looseNeuralNetwork = std::make_unique<NeuralNetworkReverse>(randomParameters, rbs_M, rbs_N);
